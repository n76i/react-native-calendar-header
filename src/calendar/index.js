 ...
 * @example: https://github.com/wix/react-native-calendar-header/blob/master/example/src/screens/calendars.js
 * @gif: https://github.com/wix/react-native-calendar-header/blob/master/demo/calendar.gif
 */
    ...
    return (
      <LinearGradient
        ...
        <View style={[this.style.container, this.props.style, { backgroundColor: '#00000000' }]}>
          ...
          />
          <View style={[this.style.monthView,{backgroundColor: '#00000000'}]}>{weeks}</View>
        </View>
      </LinearGradient>
    );
  }
